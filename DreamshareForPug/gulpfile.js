...
function watcher() {
  ...
  // gulp.watch(path.watch.html, gulp.series(html, ftp)); // gulp.series(html, ftp)

  gulp.watch(path.watch.scss, scss); // gulp.series(scss, ftp)
  // gulp.watch(path.watch.scss, gulp.series(scss, ftp)); // gulp.series(scss, ftp)

  
  gulp.watch(path.watch.js, js); // gulp.series(js, ftp)
  // gulp.watch(path.watch.js, gulp.series(js, ftp)); // gulp.series(js, ftp)
